...
declare module Ammo {
    ...
    class btUniformScalingShape extends btConvexShape {
        constructor(convexChildShape: btConvexShape, uniformScale: number);
        getUniformScalingFactor(): number;
    }
    class btScaledBvhTriangleMeshShape extends btConcaveShape {
