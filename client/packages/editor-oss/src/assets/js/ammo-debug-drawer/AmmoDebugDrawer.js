...
export const AmmoDebugDrawer = function(AmmoLib, indexArray, verticesArray, colorsArray, world, options) {
  Ammo = AmmoLib;
...
AmmoDebugDrawer.prototype.dispose = function() {
  if (this.debugDrawer) {
    // Remove debug drawer from world before destroying
    if (this.world) {
      this.world.setDebugDrawer(null);
    }
    
    // Destroy the Ammo debug drawer object
