...
class BufferGeometryUtils {
    ...
    static computeMorphedAttributes(object) {
         ...
         * @param material
         * @param attribute
         * @param morphAttribute
         * @param morphTargetsRelative
         * @param a
         * @param b
         * @param c
         * @param modifiedAttributeArray
         */
        ...
        const morphedPositionAttribute = new THREE.BufferAttribute(modifiedPosition, 3);
        const morphedNormalAttribute = new THREE.BufferAttribute(modifiedNormal, 3);
        return {
