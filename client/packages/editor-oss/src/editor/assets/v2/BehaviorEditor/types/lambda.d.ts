...
interface Lambda {
    ...
    /** Instance attributes. Foreign lambda instances expose this as read-only. */
    ...
    /** Request a change to a scene-level lambda attribute */
    requestAttributeChange(
        key: string,
        value: any,
        options?: { sync?: boolean },
    ): Promise<{ accepted: boolean; key: string; value?: any; previousValue?: any }> | { accepted: boolean; key: string; value?: any; previousValue?: any };
}
