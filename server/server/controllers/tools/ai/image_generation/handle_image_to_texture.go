...
type ImageToTextureRequest struct {
...
func init() {
	serverContext.Handle(http.MethodPost, "/api/AI/ImageGeneration/ImageToTexture", handleImageToTexture, constants.User)
}

func handleImageToTexture(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := client.MakeRequest("POST", "/generate/img2img-texture", payload)
	if err != nil {
