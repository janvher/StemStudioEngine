...
type TextToSkyboxRequest struct {
...
func init() {
	serverContext.Handle(http.MethodPost, "/api/AI/ImageGeneration/TextToSkybox", handleTextToSkybox, constants.User)
}

func handleTextToSkybox(w http.ResponseWriter, r *http.Request) {
	...
	payload := map[string]interface{}{
		...
		"numOutputs":        req.NumSamples,
		"guidance":          3.5,
		"width":             req.Width,
		"style":             req.Style,
	}

	resp, err := client.MakeRequest("POST", "/generate/skybox-base-360", payload)
	if err != nil {
