...
function initializePointerEvents(): void {
    ...
    const camera = gameRef.uiCamera as PerspectiveCamera | OrthographicCamera | undefined;
    const canvas = window.document.getElementsByTagName("body")[0]; //gameRef.app?.renderer?.domElement;
