#!/usr/bin/env python3
"""Search for behavior assets in the Studio 3D library."""
import sys, os; sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', '_lib'))
from studio import studio_get, add_session_args, output
import argparse

parser = argparse.ArgumentParser(description="Search for behavior assets in the Studio 3D library")
...
data = studio_get("library-behaviors", params, args.url, timeout=360)
